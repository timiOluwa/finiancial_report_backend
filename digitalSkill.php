...
?>
        ...
        <div class="header d-flex my-3 align-items-center justify-content-between">
            <h3 class="">Records for Digital Skill Academy</h3>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-uppercase fw-bold text-danger text-body" id="exampleModalLabel">Add a New Record For Digital Skill Academy</h5>
      ...
      <div class="modal-body">
            ...
            <select required name="courses" class="p-3 border-2 border-secondary rounded w-100" id="incomeDescription">
                ...
                <input class="p-3 border-1 border-secondary rounded w-100"  placeholder="Specify the custom description of income" name="noOfStudent" type="number">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th class="border px-2 py-2">
                    <a href="update_digital.php?id=<?=$skill["id"]?>" class="btn text-white btn-success" >Update</a>
            ...
            <?php endforeach ?>
                ...
                <th class="border px-2 text-white py-2 fw-bold bg-success "><?= "= ". number_format($total_student ) . " students"; ?> </th>
                <th class="border px-2 text-white py-2 fw-bold bg-success text-uppercase"><?= "= ". number_format($amount_earned); ?> </th>
