...
<section class="d-flex bg-opacity-50 w-100 ">
    <div class="w-100 d-flex ">
        ...
        <div class=" align-items-center bg-secondary bg-opacity-10 w-100 p-5 justify-content-center" style="margin-left: 20%; width: 100%;" >
            <h1 class="p-4 text-center rounded position-sticky bg-danger bg-opacity-75 text-white text-uppercase fw-bold  h-screen" style="width: 95%"><i class="fas fa-receipt me-3"></i>expenses records</h1>
            <div class="bg-white mt-1 py-3 px-4 bg-opacity-75  h-screen rounded"
            style="width: 95%">
            <?php
            if ($from && $to) {
    ...
    ?>
        ...
        <tbody>
            ...
            <?php endforeach ?>
                ...
                <th class="border px-2 text-white py-2 fw-bold bg-danger text-uppercase"><?= "= ". number_format($amount_spent); ?> </th>
