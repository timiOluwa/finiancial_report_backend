...
<body class="">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-uppercase fw-bold text-body" id="exampleModalLabel">Add a New Record
                            For Printing Service</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select required name="incomeDescription" name
                                class="p-3 border-2 border-secondary rounded w-100" id="incomeDescription">
                            ...
                            <input class="p-3 border-1 border-secondary rounded w-100"
                                placeholder="Specify the custom description of income" name="description" type="text">
    ...
    <section class="d-flex flex-column p-5  bg-opacity-50 " style="margin-left: 20%;">
        ...
        <h1 class="p-4 text-center rounded position-sticky w-100 bg-success text-white text-uppercase fw-bold  h-screen"
            ><i class="fas fa-computer mx-3"></i> Basic ICT Records</h1>
        <div class="bg-white shadow-sm p-5 w-100 mt-1  bg-opacity-75  h-screen rounded" style="width: 95%">
            <?php
            if ($from && $to) {
            ...
            <table class="w-100 table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <?php endforeach ?>
                    <th colspan="2" class="border px-2 text-success py-2 fw-bold text-uppercase"> Total Income
                    </th>
